...
VBoxManage modifyvm "${VMNAME}" --nic1 bridged --nictype1 82540EM --bridgeadapter1 "${BNETWORK}" --cableconnected1 on --macaddress1 00AFFEAFFE01
...
ssh -o "StrictHostKeyChecking no" -i vm.key root@192.168.1.12 ${JOINCOMMAND}

scp -r .kube root@192.168.1.12:/root/.kube
